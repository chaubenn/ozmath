  ...
  try {
    ...
    const response = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: "You are a mathematics grading assistant. Grade the answer and return only the marks awarded based on the marking scheme. Reward full marks if the user returns the final answer, else give part marks according to the marking scheme. If no 'final answer' exists in the marking scheme, follow marking scheme normally."
        },
        {
          role: "user",
          content: `
