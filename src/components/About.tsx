...
export default function About() {
  ...
  const imageFileId = '1vtHzM3QV5cOzXjlwac1t_UXPWVtblGfi';
  const embedUrl = `https://drive.google.com/file/d/${imageFileId}/preview`;
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="md:col-span-2 space-y-6">
            <div className="prose dark:prose-invert max-w-none">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                ...
                master mathematical concepts at their own pace, one at a time. Through interactive problems, 
          ...
          <div className="md:col-span-1 flex flex-col items-center">
            <div className="aspect-square rounded-lg bg-gray-100 dark:bg-gray-700 overflow-hidden pointer-events-none">
              <iframe
                src={embedUrl}
            ...
            <div className="mt-4 flex items-center gap-4">
              ...
              <a 
                href="mailto:benjaminchau05@gmail.com"
                className="flex items-center gap-2 text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 transition-colors"
              >
